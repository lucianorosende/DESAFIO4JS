...
const age1 = numberParse("Ingresa la edad de el/la que se va a casar");
const age2 = numberParse("Ingresa su dia del cumpleaños(1-31)");
const age3 = numberParse("Ingresa un numero del 1 al 5 para la buena suerte");
const age4 = numberParse("Ingresa ingresa la edad de su novio/a");
